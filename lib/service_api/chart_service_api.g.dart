...
class _ChartApiService implements ChartApiService {
  ...
  Future<PartialMonthlyStatModel> getMonthlyStats(
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'today': today};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PartialMonthlyStatModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late PartialMonthlyStatModel _value;
    try {
      _value = PartialMonthlyStatModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
